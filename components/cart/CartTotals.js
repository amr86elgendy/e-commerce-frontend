    ...
    <section className='flex justify-center mt-10 md:justify-end'>
      <div>
        <article className='px-8 py-6 border border-gray-300 rounded shadow-md sm:px-12'>
          <h5
            className={`grid grid-cols-[125px,1fr] sm:grid-cols-[200,1fr] sm:text-lg`}
          >
            subtotal
            <span>{total_amount}</span>
          </h5>
          <p
            className={`grid grid-cols-[125px,1fr] sm:grid-cols-[200,1fr] capitalize mb-2`}
          >
            shipping fee
          ...
          <hr />
          <h4
            className={`grid grid-cols-[125px,1fr] sm:grid-cols-[200,1fr] mt-8  sm:text-xl`}
          >
            order total
